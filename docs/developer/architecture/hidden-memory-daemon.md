...
This page is a design document for the watcher/automation daemon and is intended for developers working on Memory Layer internals.
...
- [Non-Goals](#non-goals)
- [Why It Must Be External](#why-it-must-be-external)
- [Responsibilities](#responsibilities)
- [Observed Signals](#observed-signals)
- [Task Window Model](#task-window-model)
