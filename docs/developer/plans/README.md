...
This section contains planning documents for larger internal features and architecture changes.

## Table of Contents

- [Memory Layer Implementation Plan](implementation-plan.md)
- [Hidden Memory Daemon Plan](hidden-memory-daemon-plan.md)
