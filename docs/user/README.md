...
- **Install and configure:** [Getting Started](getting-started.md), [Wizard And Bootstrap](cli/wizard.md), [Init Bootstrap](cli/init.md), [Demo](cli/demo.md), [Tour](cli/tour.md), [Skill Upgrade](cli/upgrade.md)
...
- **Capture and ask useful questions:** [Remember](cli/remember.md), [Capture](cli/capture.md), [Ingest](cli/ingest.md), [Query Command](cli/query.md), [Resume Briefings](cli/resume.md), [Source Provenance Verification](cli/verify-provenance.md), [Code Graph Extraction](cli/graph.md), [Embedding Operations](cli/embeddings.md)
- **Operate agents:** [Authentication And Access](cli/auth.md), [Agent Workspace Coordination](cli/agents.md), [Agents Tab](tui/agents.md), [Watcher Health](cli/watchers.md), [Activity Tab](tui/activity.md), [Get Up To Speed](cli/up-to-speed.md), [MCP Server](cli/mcp.md), [Codex Desktop Plugin](codex-desktop-plugin.md), [Loop Automations](cli/loops.md)
...
- [Authentication And Access](cli/auth.md)
- [Codex Desktop Plugin](codex-desktop-plugin.md)
...
- [Ingest Command](cli/ingest.md)
- [Proposals Command](cli/proposals.md)
- [Consolidation](cli/consolidate.md)
- [Memory Structure](cli/structure.md)
- [Reinforcement Scores](cli/scores.md)
- [Memory Validation](cli/validate.md)
- [Validation Review](cli/review.md)
