...
pub(crate) use mem_record::compose::{
    build_implementation_canonical_text, build_plan_execution_idempotency_key,
    build_task_start_canonical_text, build_task_start_idempotency_key, derive_summary,
    is_refactor_completion,
};
use mem_record::{
