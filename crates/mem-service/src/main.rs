...
mod tests {
    ...
    fn mcp_http_auth_accepts_bearer_or_x_api_token() {
        ...
        assert!(routes::mcp_token_matches(&headers, "service-token"));
    ...
    fn mcp_origin_validation_rejects_cross_origin() {
        ...
        assert!(routes::validate_mcp_origin(&headers, "127.0.0.1:4040").is_ok());

        headers.insert(header::ORIGIN, "https://example.com".parse().unwrap());
        assert_eq!(
            routes::validate_mcp_origin(&headers, "127.0.0.1:4040"),
