...
pub(crate) use mem_api::{
    ...
    AgentWorkspaceStatus, AgentWorkspaceWarning, AppConfig, ArchiveMemoryResponse,
    ArchiveRequest, ArchiveResponse, CaptureTaskRequest, CheckpointActivityRequest,
    CodeGraphResponse, CodeGraphStatusResponse, CodeGraphViewFilters, CodeGraphViewRequest,
    CommitDetailResponse, CommitSyncRequest, CommitSyncResponse, CurateRequest,
    DeleteMemoryRequest, DeleteMemoryResponse, DiagnosticInfo, DiagnosticSeverity,
