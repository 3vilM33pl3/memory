...
pub(crate) use mem_api::{
    ...
    LlmAuditStatusResponse, LoopApprovalDecisionRequest, LoopApprovalDecisionResponse,
    LoopApprovalRequestRecord, LoopApprovalStatus, LoopApprovalsResponse, LoopCancelRequest,
    LoopContextInstructionRef, LoopContextPack, LoopContextPackRequest, LoopContextPackResponse,
    LoopDefinitionRecord, LoopDefinitionResponse, LoopDefinitionsResponse, LoopFeedbackRequest,
    LoopGlobalStateResponse, LoopGlobalStateUpdateRequest, LoopMemoryProposalCreateRequest,
    LoopMemoryProposalDecisionRequest, LoopMemoryProposalDecisionResponse,
    LoopMemoryProposalRecord, LoopMemoryProposalsResponse, LoopMode, LoopRiskLevel, LoopRunDetail,
    LoopRunRequest, LoopRunResponse, LoopRunStatus, LoopRunSummary, LoopRunsResponse,
    LoopScopeType, LoopSettingRecord, LoopSettingResponse, LoopSettingsUpdateRequest,
    LoopTraceRecord, LoopTriggerEventRecord, LoopTriggerRouteRequest, LoopTriggerRouteResponse,
    LoopTrustLevel, MemoryEntryResponse, MemoryHistoryResponse, MemorySourceRecord,
...
pub(crate) use mem_search::{
    ...
    parse_source_kind, prune_project_embeddings, rebuild_chunks,
