class MemoryLayer < Formula
  ...
  url "https://github.com/3vilM33pl3/memory/releases/download/v2.0.1/memory-2.0.1.tar.gz"
  sha256 "75f11a0d685cef967b9ed3acdeb45b5a2a95268cbeb7c45afd9a364437c4adf7"
