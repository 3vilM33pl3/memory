...
description: "Use context pressure as a signal for briefings and capture."
---

# Token pressure

Use context pressure as a signal for briefings and capture.
...
Return to [Watchers](/watchers) or continue with the related page in the left navigation.
