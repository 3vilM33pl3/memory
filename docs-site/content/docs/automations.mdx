...
| Surface | Use it for |
|---|---|
| Web UI Automations tab | Inspect definitions, settings, recent runs, approvals, context packs, and memory proposals. |
...
Read [Web UI](/docs/web-ui), [CLI reference](/docs/reference/cli/integrations-evals), or [Operations](/docs/operations).
