---
title: "Retrieval"
description: "Learn how keyword, vector, graph-aware, and filtered retrieval work together."
---

# Retrieval

Learn how keyword, vector, graph-aware, and filtered retrieval work together.
...
```mermaid
flowchart LR
    Q[Question] --> K[Keyword candidates]
    Q --> V[Embedding candidates]
    Q --> G[Graph context]
    K --> R[Rank and merge]
    V --> R
    G --> R
    R --> E[Answer with evidence]
```
