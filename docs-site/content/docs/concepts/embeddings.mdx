---
title: "Embeddings"
description: "Use optional embedding spaces without locking yourself into one provider."
---

# Embeddings

Use optional embedding spaces without locking yourself into one provider.

![Memory Layer embeddings tab](/images/tui/embeddings-tab.png)
