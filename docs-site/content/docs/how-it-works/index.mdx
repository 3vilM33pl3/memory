...
Memory Layer stores canonical memories, raw captures, history, proposals, activity, embeddings, commit evidence, and graph references in PostgreSQL with pgvector. The database is the shared backend for the CLI, TUI, web UI, watchers, and MCP server.
...
<CardGroup cols={3}>
  <Card title="Three things to know" href="/docs/how-it-works/mental-model">
    The whole mental model on one page: memories, retrieval, reinforcement.
  </Card>
