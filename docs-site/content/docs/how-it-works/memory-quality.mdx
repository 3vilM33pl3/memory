...
| Procedural utility | Maintenance | Proposal approve/edit/reject outcomes, citation bonus | Advisory recommendations only |
...
- Fu, W.-T. & Anderson, J. R. (2006). [From recurrent choice to skill learning: a reinforcement-learning model.](https://doi.org/10.1037/0096-3445.135.2.184) *Journal of Experimental Psychology: General* — the delta-rule utility learning behind ACT-R's procedural module, used here to learn each automation loop's value from proposal outcomes.
