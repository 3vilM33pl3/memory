...
If you use Codex Desktop, the [Codex plugin](/docs/codex-plugin) is the supported way to add the Memory Layer MCP connection and workflow skill. These prompts remain useful for generic coding agents and repo initialization.
