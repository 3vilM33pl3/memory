...
The hidden contributor utilities `memory completion` and `memory dev` remain documented in [Setup and bootstrap](/docs/reference/cli/setup). They are intentionally not part of the everyday root-command inventory above.
