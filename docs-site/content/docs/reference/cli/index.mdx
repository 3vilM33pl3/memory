...
| [Integrations and evals](/docs/reference/cli/integrations-evals) | `tui`, `watcher`, `mcp`, `eval` | Opening UIs, attaching agents, serving MCP, and measuring memory quality. |
