...
Understand repo-local project files and what belongs in source control.
...
Return to [Reference](/docs/reference) or use [Doctor and health](/docs/help/doctor-and-health) for diagnostics.
