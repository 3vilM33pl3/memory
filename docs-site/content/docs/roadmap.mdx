...
The full, tracked roadmap — with per-ticket scope, reuse pointers, and estimates — lives in [`docs/roadmap.md`](https://github.com/3vilM33pl3/memory/blob/main/docs/roadmap.md) in the repository and in the Memory Layer Linear project.
